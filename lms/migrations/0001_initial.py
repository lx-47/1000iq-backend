    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('tutor', 'Tutor'), ('admin', 'Admin')], max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses_enrolled', models.ManyToManyField(blank=True, related_name='enrolled_students', through='lms.CourseEnrollment', to='lms.course')),
